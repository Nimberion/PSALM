...
<script lang="ts">
	...
	export default class EditStaffForm extends Vue {
		@Prop({ required: true }) _firstName!: string;
		@Prop({ required: true }) _lastName!: string;
		@Prop({ required: true }) _fullTime!: boolean;
