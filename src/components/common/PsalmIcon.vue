<template>
	...
	<!-- CALENDAR-PLUS -->
	<svg v-if="name === 'calendar-plus'" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="calendar-plus" class="h-[1em]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
		<path
			fill="currentColor"
	...
	<!-- COPY -->
	<svg v-else-if="name === 'copy'" aria-hidden="true" focusable="false" data-prefix="far" data-icon="copy" class="h-[1em]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
		<path
			fill="currentColor"
	...
	<!-- SAVE -->
	<svg v-else-if="name === 'save'" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="save" class="h-[1em]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
		<path
			fill="currentColor"
	...
	<!-- TRASH -->
	<svg v-else-if="name === 'trash'" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="trash-alt" class="h-[1em]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
		<path
			fill="currentColor"
	...
	<!-- USER-PLUS -->
	<svg v-else-if="name === 'user-plus'" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="user-plus" class="h-[1em]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
		<path
			fill="currentColor"
	...
	<!-- USERS-COG -->
	<svg v-else-if="name === 'users-cog'" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="users-cog" class="h-[1em]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
		<path
			fill="currentColor"
	...
	<div v-else class="text-xs">Error</div>
</template>
