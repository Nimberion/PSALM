<template>
	<div class="absolute top-0 left-0 bottom-0 h-full min-h-screen min-w-[100vw] grid place-items-center bg-[rgba(0,0,0,0.8)] overflow-hidden">
		<div class="w-[450px] bg-white shadow-lg z-50">
			...
			<div class="h-[30px] flex justify-between items-center shadow-lg select-none">
				...
				<button @click="$emit('cancel')"><PsalmIcon name="close" class="text-[30px] p-[5px] hover:bg-danger hover:text-white" /></button>
			</div>
			<!-- CONTENT -->
			<div class="p-6">
